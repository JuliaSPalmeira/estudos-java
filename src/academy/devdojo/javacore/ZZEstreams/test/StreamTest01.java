...
public class StreamTest01 {
    ...
    public static void main(String[] args) {
        lightNovels.sort(Comparator.comparing(LightNovel::getTitle)); //logica pra ordernar por titulo
        ...
        //Comparator.comparing passo o metodo q quero chamar e ele chama os dois
    }
}
