...
public class LocaleTeste01 {
    public static void main(String[] args) {
        // pt-BR duas iso (formatação da data no estilo do pais mas em uma linguagem determinada)
        ...
        //exibindo local com a linguagem definida
        System.out.println(localeCH.getDisplayCountry());
        // exibindo pais na tradução do sistema operacional q esta
        System.out.println(localeJapao.getDisplayLanguage(localeItaly));
        // como falar japones em italiano
